...
const bg = {
  ...
  'form.success': 'Получих запитването ви. Ще отговоря до 1 работен ден на {email}.',
  'form.sentTitle': 'Запитването е получено',
  'form.errorTitle': 'Изпращането не успя',
  'form.error.network': 'Връзката прекъсна. Опитайте отново или ми пишете на имейл.',
  ...
  'error.consent': 'Отбележете съгласието, за да мога да ви отговоря',
  'error.turnstile': 'Проверката против ботове не мина. Опитайте отново.',
  'error.rate': 'Твърде много запитвания от този адрес. Опитайте след час или ми пишете на имейл.',
  'error.generic': 'Изпращането не успя. Опитайте отново или ми пишете на имейл.',
  // Автоотговор (COPY.md §Микрокопи)
  'mail.autoreply.subject': 'Получих запитването Ви',
  'mail.autoreply.body':
    'Здравейте,\n\nПолучих запитването ви. Ще отговоря до 1 работен ден на {email}. Ако е спешно – обадете се на {phone}.\n\nМартин Панков\nPankov Solutions',
...
const en: Record<UiKey, string> = {
  ...
  'form.success': 'I have received your inquiry. I will reply within 1 business day to {email}.',
  'form.sentTitle': 'Inquiry received',
  'form.errorTitle': 'Sending failed',
  'form.error.network': 'The connection dropped. Try again or write to me by email.',
  ...
  'error.consent': 'Tick the consent box so I can reply to you',
  'error.turnstile': 'The bot check failed. Please try again.',
  'error.rate': 'Too many inquiries from this address. Try again in an hour or write to me by email.',
  'error.generic': 'Sending failed. Try again or write to me by email.',
  'mail.autoreply.subject': 'I have received your inquiry',
  'mail.autoreply.body':
    'Hello,\n\nI have received your inquiry. I will reply within 1 business day to {email}. If it is urgent, call {phone}.\n\nMartin Pankov\nPankov Solutions',
